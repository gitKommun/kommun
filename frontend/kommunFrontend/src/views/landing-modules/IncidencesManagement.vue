<template>
  <section
    class="container max-w-[1280px] mx-auto flex flex-col md:flex-row items-start py-12 my-20 px-6"
  >
    <div class="w-full md:w-1/2 overflow-hidden order-2 md:order-1">
      <InfiniteCarousel />
    </div>

...
from .views import PropertyUpdateAPIView, list_properties, PropertyCreateAPIView, PropertyDeleteAPIView, BulkUploadPropertiesView, BulkCreatePropertiesFromCatastroAPIView

...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('communities', '0004_remove_propertyrelationship_property_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_relationships', to='communities.usercommunityrole')),

...
from .views import CommonAreaListAPIView, CommonAreaDetailAPIView, CommonAreaCreateAPIView, ReservationListAPIView, ReservationCreateAPIView, DeleteReservationAPIView
